...
def serve404Response(filename, isGetRequest):
    html = ("<title>Error 404</title><h1><center>Error 404: File not found!</h1><br>"
            "<center>You have requested for a non existing file: <b>" + filename[1:] + "</b><br><br>"
            "Hello.html is the only present file here. </center>")
...
def HomePageResponse():
    html = ("<title>Welcome</title><center><b><h1>Welcome!</h1></b><br>"
            "This web server is created by <b>Vinay Singh</b><br><br>"
            "This is basic implementation of web server using python. :)</center>")
